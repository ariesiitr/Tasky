      ...
      <div className="w-1/4 bg-white shadow-lg">
        ...
        <div className="p-4">
          <nav>
            <ul>
              <li className="mb-2">
                <a href="" className="block p-2 rounded hover:bg-gray-200">Assigned</a>
              </li>
              <li className="mb-2">
                <a href="#" className="block p-2 rounded hover:bg-gray-200">Completed</a>
              </li>
              <li className="mb-2">
                <a href="#" className="block p-2 rounded hover:bg-gray-200">Upcoming</a>
              </li>
            </ul>
          </nav>
          <div className="mt-6">
